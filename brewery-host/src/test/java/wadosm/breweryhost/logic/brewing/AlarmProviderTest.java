...
class AlarmProviderTest {
    ...
    static Stream<Arguments> alarm_disabled_by_default() {
        return Stream.of(
                Arguments.of((Float) null, BrewingSettings.builder()
                        .enabled(true)
                        .temperatureAlarmEnabled(true)
                        .destinationTemperature(50.0f)
                        .build()),

                Arguments.of(49.0f, BrewingSettings.builder()
                        .enabled(true)
                        .temperatureAlarmEnabled(true)
                        .destinationTemperature(50.0f)
                        .build()),

                Arguments.of(100.0f, BrewingSettings.builder()
                        .enabled(false)
                        .temperatureAlarmEnabled(true)
                        .destinationTemperature(50.0f)
                        .build()),
                ...
                Arguments.of(100.0f, BrewingSettings.builder().build())
        );
    }

    @ParameterizedTest
    @MethodSource
    void alarm_disabled_by_default(Float currentTemperature) {
        // given
    ...
    void alarm_enabled_after_threshold() {
        ...
        // when
        alarmProvider.handleAlarm(51.0f);
    ...
    void timeout_reset_after_alarm_off() {
        ...
        when(timeProvider.getCurrentTime()).thenReturn(Instant.ofEpochMilli(3500));
        alarmProvider.handleAlarm(49.0f);
